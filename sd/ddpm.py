...
class DDPMSampler:
    ...
    def _get_variance(self, timestep: int):
        ...
        # Compute using formul (7) of the DDPM paper
    ...
    def set_strength(self, strength=1):
        start_step = self.num_training_steps - int(self.num_training_steps * strength)
    ...
    def add_noise(self, original_samples: torch.FloatTensor, timesteps: torch.IntTensor) -> torch.FloatTensor:
        ...
        sqrt_alpha_prod = alpha_cumprod[timesteps] ** 0.5  # square root
        ...
        # According to the equation(4) ddpm paper
